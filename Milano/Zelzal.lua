...
Status = true
elseif UserId == 1427981991 or UserId == 1427981991 or UserId == 1427981991 or UserId == 1427981991 then
Status = true
...
elseif UserId == 14279819913 or UserId == 1427981991 or UserId == 14279819913 or UserId == 142798199100 then
...
if tonumber(msg.sender_id.user_id) == 1427981991 then
msg.Name_Controller = 'مبرمج السورس🎖️'
msg.The_Controller = 1
elseif tonumber(msg.sender_id.user_id) == 1427981991 or tonumber(msg.sender_id.user_id) == 1427981991 or tonumber(msg.sender_id.user_id) == 1427981991 then
...
if tonumber(msg.sender_id.user_id) == tonumber(1427981991) then 
...
usersend = true
elseif tonumber(msg.sender_id.user_id) == tonumber(1427981991) then 
usersend = true
else
usersend = false
end
...
if msg.sender_id.user_id ~= 1427981991 or msg.sender_id.user_id ~= 1427981991 then 
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(1427981991) or tonumber(Message_Reply.sender_id.user_id) == tonumber(925972505) then
return send(msg_chat_id,msg_id,"*يحمـار دا مبرمج السورس ممكن يفشخني انا وانتـه 😂😞*","md",true)  
end
if tonumber(Message_Reply.sender_id.user_id) == tonumber(1427981991322) or tonumber(Message_Reply.sender_id.user_id) == tonumber(5280339206) or tonumber(Message_Reply.sender_id.user_id) == tonumber(1985225531) or tonumber(Message_Reply.sender_id.user_id) == tonumber(Sudo_Id) then
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(1427981991432) or tonumber(Message_Reply.sender_id.user_id) == tonumber(5280339206) or tonumber(Message_Reply.sender_id.user_id) == tonumber(1985225531) or tonumber(Message_Reply.sender_id.user_id) == tonumber(Sudo_Id) then
...
---------------------- Dev ZilZal ----------------------
local Bot_Name = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميلانو")
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Message_Reply.sender_id.user_id) == tonumber(1427981991) or tonumber(Message_Reply.sender_id.user_id) == tonumber(925972505) or tonumber(Message_Reply.sender_id.user_id) == tonumber(2095357462) then
return send(msg.chat_id,msg.id,"*يحمـار دا مبرمج السورس ممكن يفشخني انا وانتـه 😂😞*","md",true)  
end
if tonumber(Message_Reply.sender_id.user_id) == tonumber(142798199132) or tonumber(Message_Reply.sender_id.user_id) == tonumber(5280339206) or tonumber(Message_Reply.sender_id.user_id) == tonumber(1985225531) or tonumber(Message_Reply.sender_id.user_id) == tonumber(Sudo_Id) then
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(142798199142) or tonumber(Message_Reply.sender_id.user_id) == tonumber(5280339206) or tonumber(Message_Reply.sender_id.user_id) == tonumber(1985225531) or tonumber(Message_Reply.sender_id.user_id) == tonumber(Sudo_Id) then
return send(msg.chat_id,msg.id,"*يحمـار ده مطـور البـوت .. تاج راسـك 😹😞*","md",true)  
end
if tonumber(Message_Reply.sender_id.user_id) == tonumber(Zelzal) then
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(142798199144) or tonumber(Message_Reply.sender_id.user_id) == tonumber(5280339206) or tonumber(Message_Reply.sender_id.user_id) == tonumber(1985225531) or tonumber(Message_Reply.sender_id.user_id) == tonumber(Sudo_Id) then
return send(msg.chat_id,msg.id,"*يحمـار ده مطـور البـوت .. تاج راسـك 😹😞*","md",true)  
end
if tonumber(Message_Reply.sender_id.user_id) == tonumber(Zelzal) then
return send(msg.chat_id,msg.id,"*يخربيت الضحك عاوز يرزل البوت 🙂😂😂*","md",true)  
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(142798199143) or tonumber(Message_Reply.sender_id.user_id) == tonumber(5280339206) or tonumber(Message_Reply.sender_id.user_id) == tonumber(1985225531) or tonumber(Message_Reply.sender_id.user_id) == tonumber(Sudo_Id) then
return send(msg.chat_id,msg.id,"*يحمـار ده مطـور البـوت .. تاج راسـك 😹😞*","md",true)  
end
if tonumber(Message_Reply.sender_id.user_id) == tonumber(Zelzal) then
...
local nnbot = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميلانو")
...
if tonumber(msg.sender_id.user_id) == tonumber(1427981991) or tonumber(msg.sender_id.user_id) == tonumber(1427981991) or tonumber(msg.sender_id.user_id) == tonumber(1427981991) then
...
{{text = '˹  𝙈𝘼𝙏𝙍𝙄𝙓 ⁦. 𓌗', url = 't.me/+5q4udhgcX8NiM2Iy '},},
}
local msg_id = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/+5q4udhgcX8NiM2Iy/12?single&caption=' ..URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if tonumber(msg.sender_id.user_id) == tonumber(1427981991) or tonumber(msg.sender_id.user_id) == tonumber(1427981991) or tonumber(msg.sender_id.user_id) == tonumber(1427981991) or tonumber(msg.sender_id.user_id) == tonumber(Sudo_Id) then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = bot.getUser(Message_Reply.sender_id.user_id)
if UserInfo.message == "Invalid user ID" then
return send(msg_chat_id,msg_id,"\n*⇜ عذرآ تستطيع فقط استخدام الامر على المستخدمين* ","md",true)  
...
local Ahmedd = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميلانو")
local bain = bot.getUser(msg.sender_id.user_id)
...
local CmdStart = '*\n⇜ اططلـق بـوت اسمـي '..(Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميلانو")..
