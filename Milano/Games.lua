...
Bot_Name = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميم")
...
local Bot_Name = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميم")
...
return send(msg.chat_id,msg.id,'\n*⇜ عليك الاشتـراك في قنـاة ميلانو لـ استخـدام الاوامـر*',"md",false, false, false, false, reply_markup)
end
...
if UserInfo.id == 1427981991 or UserInfo.id == 1427981991 or UserInfo.id == 1427981991 then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على مطوري ياورع !!*',"md",true) 
elseif UserInfo.id == 1427981991 then
...
if msg.sender_id.user_id == 1427981991 or msg.sender_id.user_id == 1427981991 or msg.sender_id.user_id == 1427981991 then
return send(msg_chat_id,msg_id,'*- يـايمـه انتـه العشـق مالـي زلــزال الهيبـه 💞😻*',"md",true) 
elseif msg.sender_id.user_id == 1427981991 then
...
hazrwinerid = Redis:get(Zelzal.."hazrwinerid"..msg.chat_id) or 1427981991
