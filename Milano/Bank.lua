...
Bot_Name = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميلانو")
...
return send(msg.chat_id,msg.id,"*⇜ عـذراً .. لا يوجد أكـواد كشـط حاليـاً 💳*\n*⇜ راسـل (مطـور ميلانو) لـ صنـع أكـواد جديـدة*","md",true)
end
end
local Texter = "\n*⇜ أكـواد الكشـط المـوجـودة في ميلانو 💳 :*\n*⇜ ارسـل الامـر (كشط) والكـود*\n\n"
