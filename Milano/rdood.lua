...
return send(msg.chat_id,msg_id,"\n*⇜ عـذراً  .. لا تستطيع استخـدام معـرف ميلانو ؟!*","md",true)  
end
...
return send(msg.chat_id,msg_id,"\n*⇜ عـذراً ميلانو ليـس مشـرفاً .. يرجـى رفعـه وإعطـائه كـافة الصـلاحيات*","md",true)  
end
...
ٴ*⋆┄─┄─┄─┄─┄─┄─┄─┄⋆*
[• قنـاة السـورس الرسميـة](https://t.me/+5q4udhgcX8NiM2Iy) .

[• قنـاة التحديثـات](https://t.me/goldenxpris) .

[•  مطـور السـورس](https://t.me/YoGolden) .
]]
